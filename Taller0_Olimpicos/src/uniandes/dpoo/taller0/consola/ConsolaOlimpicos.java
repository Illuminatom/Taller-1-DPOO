...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta dado su nombre");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Le muestra al usuario a que pais pertenece un atleta
	 */
	private void ejecutarpaisAtletaporNombre()
	{
		System.out.println("\n" + "Pais de un atleta dado el nombre" + "\n");
		
		String nombreAtleta = input("Por favor ingrese el nombre del Atleta");
		System.out.println("\n" + "El pais de " + nombreAtleta + " es " + calculadora.paisAtletaporNombre(nombreAtleta) + "\n");
	}
